...
LB_GPS::LB_GPS()
{
  ...
  timeGPS = (char*) "00,00,00";		// initialization time by default
  dateGPS = (char*) "00,00,2012";	// initialization date by default
  coordinates = (char*) "0000.000,N,00000.000,E,0000"; // Malmo, Sweden, coordinates for a weather station
}
